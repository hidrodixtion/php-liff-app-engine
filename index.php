    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2" ng-controller="listContactCtrl">
        ...
        <div id="edit-data" class="well" style="display:none;">
            <form id="eform-data">
                ...
                <input type="reset" value="Reset" onclick="" class="btn btn-warning btn-small" />
                <input type="button" value="Cancel" onclick="gantiMenu('list-catatan');" class="btn btn-warning btn-small" />
            </form>
        </div>
        ...
        <div id="lihat-data" class="well" style="display:none;">
            <form id="eform-data">
                ...
                <input type="button" value="Kembali" onclick="gantiMenu('list-catatan');" class="btn btn-warning btn-small" />
            </form>
        </div>
